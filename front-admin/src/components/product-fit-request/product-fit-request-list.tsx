...
export const ProductFitRequestList: FC<ListProps> = (props) => {
  ...
  const renderBrand = (brandId) => {
    return (dataContext.BRAND_MAP[brandId]) ? dataContext.BRAND_MAP[brandId].nameEn : '';
  }
                          ...
                          >
                            {
                              item.imageUrlList[0]
                                  ? (
                                      <ImageInListWidget imageName={item.imageUrlList[0]}
imageUrl={item.imageUrlList[0].imageUrl} />
                                  )
                                  : (
                                      <Box
                                          sx={{

...
const BtbProductFitReAssignList = (props) => {
    const {
        lists,
        count,
        onPageChange,
    ...
    return (
        <>
                            ...
                            return (
                                <Fragment key={item.id}>
                                    ...
                                    >
                                        ...
                                        <TableCell align="center">
                                            {getDataContextValue(dataContext, 'BTB_ASSIGN_PRIORITY', item.priorityType, null)}
                                        </TableCell>
                                        <TableCell align="center">
                                            {getDataContextValue(dataContext, 'BTB_ASSIGN_STATUS', item.jennieFitAssignmentStatus, null)}
                                        </TableCell>
                                        <TableCell align="center">
                                            {item.workerName}
                                        </TableCell>
            ...
            {lists.length == 0 && <Stack sx={{mt:5, mb: 5, textAlign: 'center'}}>재배정 가능한 상품이 없습니다.</Stack>}
            <TablePagination
                component="div"
                count={count}
                onPageChange={onPageChange}
...
export default BtbProductFitReAssignList;
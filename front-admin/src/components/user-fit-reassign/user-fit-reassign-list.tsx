...
export const UserFitReassignList: FC<ListProps> = (props) => {
                ...
                return (
                    <Fragment key={item.id}>
                      ...
                      >
                        ...
                        <TableCell>
                          {item.isAi ? "AI 피팅 처리" : item.maskless ? "마스크 X" : '-'}
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          {getDate(item.userDressCreatedDate)}
                        </TableCell>
                      </TableRow>
                    </Fragment>
                );

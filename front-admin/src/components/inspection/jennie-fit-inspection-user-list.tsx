...
const RejectDialog = (props) => {
  ...
  const handleSave = async () => {
    ...
    //   ids.push(item.id)
    // })
    // const result = await jennieFitUserAssignmentApi.patchWorkStatus(ids, 'REJECTED' );
    // /*******************************************************************************/
...
export const JennieFitInspectionUserList: FC<ListProps> = (props) => {
                ...
                return (
                    <Fragment key={item.id}>
                      ...
                      >
                        ...
                        <TableCell>
                          <ImageInListWidget imageName={item.userDressId}
                                             imageUrl={item.warpMaskImageUrl} />
                        </TableCell>
...
JennieFitInspectionUserList.propTypes = {

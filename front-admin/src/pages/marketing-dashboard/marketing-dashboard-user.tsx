...
const MarketingDashboardUser: FC<ListProps> = (props) => {
    ...
    const getUserAllList = async () => {
        await marketingApi.getUserAll(search).then(res => {
            setUser([...res.lists].reverse());
...
export default MarketingDashboardUser;
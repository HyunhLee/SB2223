...
const AccountButton = () => {
    ...
    return (
        <>
            <Stack direction={'row'}>
                <NotificationsNoneIcon color="primary" cursor={'pointer'} sx={{mt:0.5}} />
                <Box sx={{
                        alignItems: 'center',
                        display: 'flex',
                        ml: 2
                ...
                <Box component={ButtonBase}
                    ...
                    {openPopover ? <KeyboardArrowUpIcon color="primary" cursor={'pointer'} /> : <KeyboardArrowDownIcon color="primary" cursor={'pointer'} /> }
                </Box>
            </Stack>
            <AccountPopover
                anchorEl={anchorRef.current}
